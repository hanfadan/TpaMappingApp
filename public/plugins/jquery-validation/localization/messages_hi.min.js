...
!(function (a) {
  ...
  return (
    a.extend(a.validator.messages, {
      ...
      range: a.validator.format('कृपया {0} और {1} के बीच एक मान दर्ज करें।'),
      max: a.validator.format('कृपया {0} से कम या उसके बराबर मान दर्ज करें।'),
      min: a.validator.format('कृपया {0} से अधिक या उसके बराबर मान दर्ज करें।'),
