  ...
  Api =
    ($.extend(Responsive.prototype, {
          ...
          i
            ...
            .on('init.dtr', function (e, t, n) {
              'dt' === e.namespace &&
                (r._resizeAuto(),
                r._resize(),
                $.inArray(!1, r.s.current) && i.columns.adjust());
            }),
          this._resize();
      },
      _childNodes: function (e, t, n) {
        ...
        for (
          var s = [], r = e.cell(t, n).node().childNodes, o = 0, d = r.length;
          o < d;
          o++
        )
          s.push(r[o]);
        ...
        if (this.s.childNodeStore[i]) {
          for (
            var s = e.cell(t, n).node(),
              r = this.s.childNodeStore[i][0].parentNode.childNodes,
              o = [],
              d = 0,
              a = r.length;
            d < a;
      ...
      _columnsVisiblity: function (n) {
            ...
            s = $.map(e, function (e, t) {
              return !1 === i.column(t).visible()
                ...
                : (!e.auto || null !== e.minWidth) &&
                    (!0 === e.auto ? '-' : -1 !== $.inArray(n, e.includeIn));
            }),
            r = 0,
            o = 0,
            d = s.length;
        ...
        for (o = 0, d = t.length; o < d; o++) {
          ...
          '-' === s[u] &&
            !e[u].control &&
            e[u].minWidth &&
            (c || l - e[u].minWidth < 0 ? (s[u] = !(c = !0)) : (s[u] = !0),
            (l -= e[u].minWidth));
        }
        var h = !1;
        ...
        for (o = 0, d = e.length; o < d; o++)
          e[o].control && (s[o] = h), 'not-visible' === s[o] && (s[o] = !1);
      ...
      _classLogic: function () {
        function d(e, t, n, i) {
          ...
          if (n) {
            if ('max-' === n)
              for (s = a._find(t).width, r = 0, o = l.length; r < o; r++)
        ...
        c.each(function (e, s) {
          for (
            var t = e.className.split(' '), r = !1, n = 0, i = t.length;
            n < i;
            n++
          ) {
            var o = t[n].trim();
            ...
            $.each(l, function (e, t) {
              ...
              i &&
                ((r = !0),
                i[2] === n[0] && i[3] === '-' + n[1]
                  ? d(s, t.name, i[1], i[2] + i[3])
                  : i[2] !== n[0] || i[3] || d(s, t.name, i[1], i[2]));
            });
          }
          r || (e.auto = !0);
        }),
      ...
      _detailsDisplay: function (t, n) {
        function e(e) {
          $(t.node()).toggleClass('parent', !1 !== e),
            $(r.table().node()).triggerHandler('responsive-display.dt', [
              r,
              t,
              e,
              n,
        ...
        o &&
          ...
          ((i =
            'string' == typeof o.renderer
              ? Responsive.renderer[o.renderer]()
              : o.renderer),
          'boolean' ==
            typeof (o = o.display(
              t,
      ...
      _detailsInit: function () {
        ...
        (void 0 === s && null === s) ||
          $(i.table().body()).on(
            ...
            function (e) {
              if (
                $(i.table().node()).hasClass('collapsed') &&
                -1 !==
                  $.inArray(
        ...
        return $.map(this.s.columns, function (e, t) {
          if (!e.never && !e.control)
            return {
              ...
              rowIndex: n,
              title:
                null !== e.sTitle ? e.sTitle : $(s.column(t).header()).text(),
            };
        });
      },
      _find: function (e) {
      ...
      _resize: function (n) {
        ...
        t
          ...
          h &&
            ($(t.table().node()).trigger('responsive-resize.dt', [
              t,
              this.s.current,
            ]),
            0 === t.page.info().recordsDisplay &&
              $('td', t.table().body()).eq(0).attr('colspan', p)),
          i._controlClass();
      },
      _resizeAuto: function () {
        ...
        this.c.auto &&
          ...
          'inline' === this.c.details.type &&
            $(e).addClass('dtr-inline collapsed'),
    ...
    (Responsive.display = {
      ...
      modal: function (o) {
        return function (e, t, n, i) {
          if (t) {
            if (
              !(r = $('div.dtr-modal-content')).length ||
              e.index() !== r.data('dtr-row-idx')
            )
              return null;
            r.empty().append(n());
          } else {
    ...
    (Responsive.renderer = {
              ...
              $(
                ...
                .append(
                  $('<span class="dtr-data"/>').append(
                    s._childNodes(i, t.rowIndex, t.columnIndex)
                  )
                )
                .appendTo(r),
              (o = !0));
      ...
      listHidden: function () {
        return function (e, t, n) {
          ...
          return (
            !!n &&
            $('<ul data-dtr-index="' + t + '" class="dtr-details"/>').append(n)
          );
        };
      },
      tableAll: function (i) {
...
Api.register('responsive()', function () {
  ...
  Api.register('responsive.hasHidden()', function () {
    ...
    return (
      !!e._responsive &&
      -1 !== $.inArray(!1, e._responsive._responsiveOnlyHidden())
    );
  }),
  Api.registerPlural(
  ...
  $(document).on('preInit.dt.dtr', function (e, t, n) {
    'dt' === e.namespace &&
      ($(t.nTable).hasClass('responsive') ||
        $(t.nTable).hasClass('dt-responsive') ||
        t.oInit.responsive ||
        DataTable.defaults.responsive) &&
