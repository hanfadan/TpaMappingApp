...
$.extend(KeyTable.prototype, {
      ...
      n =
        ...
        this.c.blurable &&
          $(document).on('mousedown' + l, function (e) {
            $(e.target).parents('.dataTables_filter, .dt-search').length &&
              o._blur(),
            ...
            (a =
              ...
              (void 0 !== n && !0 !== n) ||
                ...
                (a = o.table().body().parentNode) !==
                  ...
                  ((n = $(a.parentNode)), this._scroll(n, n, r, 'position'))),
              o.page.info()));
          (this.s.lastFocus = {
            cell: l,
            node: l.node(),
            relative: {
              row:
                a.start +
                o.rows({ page: 'current' }).indexes().indexOf(l.index().row),
  ...
  _key: function (n) {
    if (this.s.waitingForDraw) n.preventDefault();
      ...
      var e = this.s.enable,
        t =
          ((this.s.returnSubmit =
            ('navigation-only' === e || 'tab-only' === e) && 13 === n.keyCode),
  ...
  _shift: function (e, t, n) {
    ...
    r &&
      ...
      'rtl' === $(s.table().node()).css('direction') &&
  ...
  _tabInput: function () {
    var n = this,
      i = this.s.dt,
      e =
        null !== this.c.tabIndex ? this.c.tabIndex : i.settings()[0].iTabIndex;
    -1 != e &&
      (this.s.tabInput ||
        ((e = $('<div><input type="text" tabindex="' + e + '"/></div>').css({
          position: 'absolute',
          height: 1,
          width: 0,
          overflow: 'hidden',
  ...
  $(document).on('preInit.dt.dtk', function (e, t, n) {
    var i, s;
    'dt' === e.namespace &&
      ((e = t.oInit.keys), (i = DataTable.defaults.keys), e || i) &&
      ((s = $.extend({}, i, e)), !1 !== e) &&
      new KeyTable(t, s);
  });
