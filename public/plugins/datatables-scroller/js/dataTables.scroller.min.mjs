...
let $ = jQuery;
var Scroller = function (t, s) {
    this instanceof Scroller
      ? (void 0 === s && (s = {}),
        (t = $.fn.dataTable.Api(t)),
        (this.s = {
          dt: t.settings()[0],
          dtApi: t,
          tableTop: 0,
        ...
        (this.s = $.extend(this.s, Scroller.oDefaults, s)),
  ...
  Api =
    ($.extend(Scroller.prototype, {
      ...
      rowToPixels: function (t, s, o) {
        ...
        return (
          (o += t * this.s.heights.row), s || void 0 === s ? parseInt(o, 10) : o
        );
      },
      scrollToRow: function (t, s) {
        var o = this,
          e = !1,
          l = this.rowToPixels(t),
        ...
        r < 0 && (r = 0),
          void 0 ===
            (s =
              ...
              ((e = !0),
              (l = this._domain('virtualToPhysical', t * this.s.heights.row)),
              this.s.redrawTop < l) &&
              l < this.s.redrawBottom
                ? !(this.s.forceReposition = !0)
                : s) || s
            ? ((this.s.ani = e),
              $(this.dom.scroller).animate({ scrollTop: l }, function () {
                setTimeout(function () {
                  o.s.ani = !1;
                }, 250);
              }))
      ...
      construct: function () {
        ...
        (this.dom.force.style.position = 'relative'),
          ...
          $(t.table().container()).addClass('dts DTS'),
          this.dom.label.appendTo(this.dom.scroller),
          this.s.heights.row &&
            'auto' != this.s.heights.row &&
            (this.s.autoHeight = !1),
          (this.s.ingnoreScroll = !0),
          $(this.dom.scroller).on('scroll.dt-scroller', function (t) {
            e._scroll.call(e);
          }),
        ...
        t.on('stateSaveParams.scroller', function (t, s, o) {
          ...
          (e.s.stateSaveThrottle = DataTable.util.throttle(function () {
          ...
          t.on('destroy.scroller', function () {
            $(window).off('resize.dt-scroller'),
              $(e.dom.scroller).off('.dt-scroller'),
              $(e.s.dt.nTable).off('.scroller'),
              $(e.s.dt.nTableWrapper).removeClass('DTS'),
              $('div.DTS_Loading', e.dom.scroller.parentNode).remove(),
      ...
      _draw: function () {
          ...
          l =
            (0 === l
              ...
              : i <= l + r
                ? (h = s.scroll - e)
                : h + e < a &&
                  ((this.s.baseScrollTop += 1 + ((i = a - e) - h)), (h = i)),
        ...
        (this.s.redrawTop = o - l),
          ...
          $(this.s.dt.nTable).triggerHandler('position.dts.dt', h);
      },
      _domain: function (t, s) {
        var o,
          e = this.s.heights,
          l = 1e4;
        return e.virtual === e.scroll || s < l
          ? s
          : 'virtualToPhysical' === t && s >= e.virtual - l
            ? ((o = e.virtual - s), e.scroll - o)
            : 'physicalToVirtual' === t && s >= e.scroll - l
      ...
      _info: function () {
        if (this.s.dt.oFeatures.bInfo) {
          var t = this.s.dt,
            ...
            o = ((a = this._macros(a, r, i, e, l)), o.fnInfoCallback),
            h =
              (o && (a = o.call(t.oInstance, t, r, i, e, l, a)),
              t.aanFeatures.i);
          if (void 0 !== h) {
            for (var n = 0, c = h.length; n < c; n++) $(h[n]).html(a);
            $(t.nTable).triggerHandler('info.dt');
          }
          $('div.dt-info', s.table().container()).each(function () {
            $(this).html(a), s.trigger('info', [s.settings()[0], this, a]);
          });
        }
      },
      _macros: function (t, s, o, e, l) {
        var r = this.s.dtApi,
          i = this.s.dt,
          a = i.fnFormatNumber;
        return t
          .replace(/_START_/g, a.call(i, s))
          .replace(/_END_/g, a.call(i, o))
          .replace(/_MAX_/g, a.call(i, e))
          .replace(/_TOTAL_/g, a.call(i, l))
          .replace(/_ENTRIES_/g, r.i18n('entries', ''))
          .replace(/_ENTRIES-MAX_/g, r.i18n('entries', '', e))
          .replace(/_ENTRIES-TOTAL_/g, r.i18n('entries', '', l));
      },
        ...
        return (
          (null !== t &&
            ...
            'px' === (t = t[2])
              ? (s = o)
              : 'vh' === t
                ? (s = (o / 100) * $(window).height())
                : 'rem' === t
                  ? (s = o * parseFloat($(':root').css('font-size')))
                  : 'em' === t &&
                    (s = o * parseFloat($('body').css('font-size'))),
            s)) ||
          0
        );
      },
    ...
    $(document).on('preInit.dt.dtscroller', function (t, s) {
      var o, e;
      'dt' === t.namespace &&
        ((t = s.oInit.scroller), (o = DataTable.defaults.scroller), t || o) &&
        ((e = $.extend({}, t, o)), !1 !== t) &&
        new Scroller(s, e);
    }),
...
Api.register('scroller()', function () {
  ...
  Api.register('scroller().rowToPixels()', function (t, s, o) {
    var e = this.context;
    if (e.length && e[0].oScroller) return e[0].oScroller.rowToPixels(t, s, o);
  }),
  Api.register('scroller().pixelsToRow()', function (t, s, o) {
    var e = this.context;
  ...
  Api.register('row().scrollTo()', function (o) {
    var e = this;
    return (
  ...
  Api.register('scroller.measure()', function (s) {
    return (
      this.iterator('table', function (t) {
